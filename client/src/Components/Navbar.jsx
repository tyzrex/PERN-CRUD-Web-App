...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className="max-w-full bg-green-600 border-gray-200 px-4 py-6 rounded">
                <div className="flex flex-wrap justify-between items-center">
                    <a href="/" className="flex items-center ">
                        <img src={Logo} className="mr-3 h-6 sm:h-9" alt="something" />
                    ...
                    <div className="flex items-center md:order-2">
                        <button type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" onClick={handleProfile} >
                            ...
                            <img className="w-8 h-8 rounded-full" src="" alt="p" />
                        </button>
                        ...
                        <button onClick={handleNav} type="button" className="inline-flex items-center ml-1 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="mobile-menu-2" aria-expanded="false">
